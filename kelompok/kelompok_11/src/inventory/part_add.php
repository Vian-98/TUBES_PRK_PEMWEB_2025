...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nama) && !empty($sku)) {
        ...
        $sql = "INSERT INTO parts (nama, sku, deskripsi, harga_beli, harga_jual, stok, supplier_id, min_stok, created_at) 
                VALUES ('$nama', '$sku', '$deskripsi', $harga_beli, $harga_jual, $stok, $supplier_id, $min_stok, NOW())";
...
<div class="flex justify-between items-center mb-6">
    <div>
        <h1 class="text-3xl font-bold text-white mb-2">Tambah Sparepart</h1>
        <p class="text-white/80">Tambah data sparepart baru ke inventory</p>
    </div>
        ...
        <form method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Contoh: Filter Oli Standar">
                </div>
            ...
            <div>
                ...
                <textarea id="deskripsi" 
                          ...
                          placeholder="Deskripsi detail sparepart..."><?= htmlspecialchars($_POST['deskripsi'] ?? '') ?></textarea>
            </div>
            
            <!-- Row 3 - Harga Beli & Harga Jual -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label for="harga_beli" class="block text-sm font-medium text-brand-dark mb-2">
                        Harga Beli (Rp)
                    </label>
                    <div class="relative">
                ...
                <div>
                    <label for="harga_jual" class="block text-sm font-medium text-brand-dark mb-2">
                        Harga Jual (Rp)
                    </label>
                    <div class="relative">
                        <span class="absolute left-4 top-3.5 text-brand-gray">Rp</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <label for="stok" class="block text-sm font-medium text-brand-dark mb-2">
                        Stok Awal
                    </label>
                    <input type="number" 
                           id="stok" 
                ...
                <div>
                    <label for="min_stok" class="block text-sm font-medium text-brand-dark mb-2">
                        Stok Minimum
                    </label>
                    <input type="number" 
                           id="min_stok" 
                ...
                <div>
                    <label for="supplier_id" class="block text-sm font-medium text-brand-dark mb-2">
                        Supplier
                    </label>
